            ...
            <div className="container">
                <div className="hero-section__body">
                    <div className='hero-section__upItems'>
                        ...
                        <div data-open={burger.visibility} className='hero-sec__burgerOpen-hidden-btn' onClick={burgerOpen}>
                    ...
                    <div className='hero-section__prtf-gallery'>
                        {
                            heroSecImages.map((item, ind) => (
                                <div key={ind} data-id={ind+1} className='hero-section__prtf-gallery__item'>
